...
if("FALSE" STREQUAL "TRUE")
  set(line_extract_SOURCE_PREFIX /home/towardthesea/catkin_ws/src/kh3ROS/line_extract)
  set(line_extract_DEVEL_PREFIX /home/towardthesea/catkin_ws/devel)
  ...
  set(line_extract_INSTALL_PREFIX /home/towardthesea/catkin_ws/install)
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir}" STREQUAL "include")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'line_extract' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'towardthesea <ph17dn@gmail.com>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'line_extract' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/towardthesea/catkin_ws/install/${idir}'.  Ask the maintainer 'towardthesea <ph17dn@gmail.com>' to fix it.")
    endif()
